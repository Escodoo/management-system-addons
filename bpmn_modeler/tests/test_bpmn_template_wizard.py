...
<bpmn:definitions xmlns:bpmn="http://www.omg.org/spec/BPMN/20100524/MODEL"
  ...
  <bpmndi:BPMNDiagram id="BPMNDiagram_1">
    ...
    def test_create_wizard(self):
        ...
        wizard = self.BpmnTemplateWizard.create(
            {
    ...
    def test_default_get_with_template(self):
        ...
        wizard = self.BpmnTemplateWizard.with_context(
    ...
    def test_action_create_diagram(self):
        ...
        diagram = self.BpmnDiagram.browse(diagram_id)
