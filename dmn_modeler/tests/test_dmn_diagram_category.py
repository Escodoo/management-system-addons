...
class TestDmnDiagramCategory(TransactionCase):
    """Test cases for DMN Diagram Category model."""
    ...
    def test_create_category(self):
        ...
        category = self.DmnDiagramCategory.create(
            {
                "name": "Test Category",
    ...
    def test_category_ordering(self):
        ...
        category1 = self.DmnDiagramCategory.create(
            {
                "name": "Category A",
                "sequence": 20,
            }
        )
        category2 = self.DmnDiagramCategory.create(
            {
                "name": "Category B",
                "sequence": 10,
            }
        )
        category3 = self.DmnDiagramCategory.create(
            {
                "name": "Category C",
                "sequence": 10,
            }
        ...
        categories = self.DmnDiagramCategory.search([])
