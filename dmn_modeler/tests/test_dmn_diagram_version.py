...
class TestDmnDiagramVersion(TransactionCase):
    """Test cases for DMN Diagram Version model."""
    ...
    def test_create_version(self):
        ...
        version = self.DmnDiagramVersion.create(
            {
        ...
        self.assertEqual(version.dmn_xml, "<original>xml</original>")
    ...
    def test_version_ordering(self):
        ...
        version1 = self.DmnDiagramVersion.create(
            {
                "diagram_id": diagram.id,
                "version": "1.0.0",
                "dmn_xml": "<v1>xml</v1>",
        ...
        version2 = self.DmnDiagramVersion.create(
            {
                "diagram_id": diagram.id,
                "version": "2.0.0",
                "dmn_xml": "<v2>xml</v2>",
        ...
        versions = self.DmnDiagramVersion.search([("diagram_id", "=", diagram.id)])
    ...
    def test_version_cascade_delete(self):
        ...
        self.assertFalse(self.DmnDiagramVersion.browse(version_id).exists())
        ...
        version = self.DmnDiagramVersion.create(
            {
                ...
                "version": "1.0.0",
                "dmn_xml": "<test>xml</test>",
                "change_note": "Fixed bug in decision table",
            }
        )

        self.assertEqual(version.change_note, "Fixed bug in decision table")
